...
export default function MecanicForm(props: MecanicFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input type="date" placeholder="Birth Date" className="border p-2 mb-2 w-full" value={register?.birth_date?.substring(0, 10) || ""} onChange={(e) => setRegister({ ...register, birth_date: e.target.value })} />
